...
Get-DCInfo
Get-ForestInfo | Out-File .\Rpt-ForestInfo.txt
Get-DomainInfo | Out-File -append .\Rpt-ForestInfo.txt
Get-DSInfo | Out-File -append .\Rpt-ForestInfo.txt
Get-GroupMemberships | Out-File .\Rpt-Groupmemberships.txt
Get-DomainControllers | Out-File .\Rpt-DomainControllers.txt
Get-DNSInfo | Out-File .\Rpt-DNSInfo.txt
Get-Interfaces | Out-File -Append .\Rpt-DomainControllers.txt
Get-Trusts | Out-File .\Rpt-Trusts.txt
Get-SiteInfo | Out-File .\Rpt-SiteInfo.txt